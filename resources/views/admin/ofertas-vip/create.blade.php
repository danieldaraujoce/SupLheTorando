...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <h2 class="text-2xl font-bold text-black">Nova Oferta VIP</h2>
    <nav>
        <ol class="flex items-center gap-1.5">
            <li><a class="text-sm text-gray-500" href="{{ route('admin.dashboard') }}">Dashboard /</a></li>
            <li><a class="text-sm text-gray-500" href="{{ route('admin.ofertas-vip.index') }}">Ofertas VIP /</a></li>
...
<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.ofertas-vip.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="md:col-span-2">
                ...
                <input type="text" name="titulo" placeholder="Ex: Cerveja Especial com 50% OFF"
        ...
        <div class="mt-9 flex justify-end gap-4 border-t border-gray-200 pt-6">
            <a href="{{ route('admin.ofertas-vip.index') }}"
