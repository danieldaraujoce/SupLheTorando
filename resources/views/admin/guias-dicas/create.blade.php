...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <h2 class="text-2xl font-bold text-black">Nova Guia ou Dica</h2>
    <nav>
...
<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.guias-dicas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="md:col-span-2">
                ...
                <input type="text" name="titulo" placeholder="Título da guia ou dica"
        ...
        <div class="mt-9 flex justify-end gap-4 border-t border-gray-200 pt-6">
            ...
            <button type="submit"
                class="flex justify-center rounded-lg bg-primary px-5 py-2.5 font-medium text-white hover:bg-opacity-90">Salvar</button>
        </div>
    </form>
</div>
@endsection