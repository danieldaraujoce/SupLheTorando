...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <h2 class="text-2xl font-bold text-black">Nova Categoria de Produto</h2>
    <nav>
...
<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.categorias-produtos.store') }}" method="POST">
        @csrf
        ...
        <div class="flex flex-col gap-6">
            <div>
                ...
                <input type="text" name="nome" placeholder="Ex: Hortifruti, Padaria, Limpeza"
