...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <h2 class="text-2xl font-bold text-black">Novo Encarte Promocional</h2>
    <nav>
...
<div class="rounded-2xl border border-gray-200 bg-white p-6">
    <form action="{{ route('admin.encartes.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="titulo" placeholder="Ex: Ofertas de Fim de Semana"
                    ...
                    <div>
                        <label class="mb-3 block text-sm font-medium text-black">Imagem de Capa (para o
                            carrossel)</label>
                    ...
                    <div>
                        <label class="mb-3 block text-sm font-medium text-black">Arquivo Principal (PDF ou
                            Imagem)</label>
